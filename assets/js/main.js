(function ($) {
  ...
  var brand_slider = new Swiper(".team-slide-wrap", {
    spaceBetween: 100,
    slidesPerView: 3,
    centeredSlides: true,
    speed: 5000,
  ...
  splitTextLines.forEach((splitTextLine) => {
    ...
    tl.from(itemSplitted.lines, { duration: 0.9, delay: 0.2, opacity: 0, rotationX: -80, force3D: true, transformOrigin: "top center -50", stagger: 0.1 });
  });
